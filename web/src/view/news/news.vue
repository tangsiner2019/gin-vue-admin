  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">                  
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增news表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="link字段" prop="link" width="120"></el-table-column> 
    ...
    <el-table-column label="title字段" prop="title" width="120"></el-table-column> 
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button @click="updateNews(scope.row)" size="small" type="primary">变更</el-button>
  ...
  data() {
    return {
      ...
      multipleSelection: [],formData: {
        cateId:null,content:null,imgPath:null,isPub:null,link:null,sort:null,status:null,subTitle:null,title:null,
      }
    };
  },
  filters: {
