...
export default {
  ...
  methods: {
    ...
    async enterDialog(item) {
      ...
      this.formData.subTitle = item.sub_title;
      ...
      this.formData.cateId = parseInt(item.cate_id);
    ...
    async getCates() {
      ...
      this.allCates = temp.filter((item) => item.type === "news");
