  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">              
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增server表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="是否发布" prop="isPub" width="120"></el-table-column> 
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button @click="updateServer(scope.row)" size="small" type="primary">变更</el-button>
          <el-popover placement="top" width="160" v-model="scope.row.visible">
            <p>确定要删除吗？</p>
            <div style="text-align: right; margin: 0">
              <el-button size="mini" type="text" @click="scope.row.visible = false">取消</el-button>
              <el-button type="primary" size="mini" @click="deleteServer(scope.row)">确定</el-button>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],formData: {
        title:null,imgPath:null,subTitle:null,content:null,status:null,sort:null,isPub:null,
      }
    };
  },
  filters: {
  ...
  methods: {
    ...
    async enterDialog() {
      ...
      switch (this.type) {
        case "create":
          res = await createServer(this.formData);
          break;
        case "update":
